...
begin
  ...
  from (
    ...
    from unnest(array[2800,2800,2088]) with ordinality as e(expected, seq)
  ...
  if md5(v_src) <> '08b98365d221b21a45130dfc30f78814' then
  ...
  execute v_src;
  raise notice 'ps_checkout_health replaced — % characters, md5 08b98365d221b21a45130dfc30f78814', length(v_src);
end $$;
