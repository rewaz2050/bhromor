-- ============================================================================
-- Full checkout restore + first-10-free promo (owner decision, 2026-09-11)
-- ============================================================================
-- SUPERSEDES 202609100001_simple_checkout_first10_free.sql — this file is
-- self-contained: run ONLY this one in Supabase SQL Editor (safe to re-run).
--
-- Rules:
