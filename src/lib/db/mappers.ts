...
export const mapOrder = (bundle: OrderRowBundle): Order => {
  ...
  return {
    ...
    scheduledAt: o.scheduled_at ? new Date(o.scheduled_at).getTime() : undefined,
    deliveryWindow: o.delivery_window ?? undefined,
    isExpress: o.is_express ?? undefined,
    isPickup: o.is_pickup ?? undefined,
    pickupSlot: o.pickup_slot ?? undefined,
    tipAmount: o.tip_amount ?? undefined,
    weightKg: o.weight_kg ?? undefined,
    surchargeNight: o.surcharge_night ?? undefined,
    surchargeRain: o.surcharge_rain ?? undefined,
    surchargeDistance: o.surcharge_distance ?? undefined,
    surchargeExpress: o.surcharge_express ?? undefined,
    surchargeWeight: o.surcharge_weight ?? undefined,
    deliveryProofUrl: o.delivery_proof_url ?? undefined,
    deliveryProofUploadedAt: o.delivery_proof_uploaded_at
      ? new Date(o.delivery_proof_uploaded_at).getTime()
      : undefined,
