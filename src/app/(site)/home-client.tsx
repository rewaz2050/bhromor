...
/**
 * Client half of the homepage: the server page (`./page`) reads the live
 * catalog + CMS settings and seeds the client stores through the
 * hydrators below, so this tree paints live rows on first paint instead
 * of after a /api/products + /api/homepage fetch waterfall.
 */
